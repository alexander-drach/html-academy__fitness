...
var slider = exports.slider = function slider() {
  var swiperTrainers = new window.Swiper('.trainers__slider', {
  ...
  var swiperReviews = new window.Swiper('.reviews__slider', {
    direction: 'horizontal',
    navigation: {
  ...
  if (window.matchMedia('(max-width: 1200px)').matches) {
    if (document.querySelectorAll('.trainers__item').length > 0) {
      var trainers = document.querySelectorAll('.trainers__item');
...
var playVideo = exports.playVideo = function playVideo() {
  ...
  if (document.querySelector('.about__video') && document.querySelector('.about__btn')) {
    ...
    var link = document.querySelector('.about__btn');
